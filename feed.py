...
for item in yaml_data['item']:
    ...
    xml_tree.SubElement(enclosure, 'length').text = item['length']
    xml_tree.SubElement(enclosure, 'type').text = 'audio/mpeg'
    xml_tree.SubElement(enclosure, 'url').text = link_prefix + item['file']
